<?php
class MsbdAdsMOptions {

    var $adsm_options_name;
    ...
    public function __construct($core) {
        ...
        $this->adsm_options_name = $core->adsm_options_name;
        $this->defaults = array(
            'version' => $core->version,
            'msbd_adsmp_view_authority' => 'edit_published_posts',
            'msbd_adsmp_manage_authority' => 'manage_options',
            'msbd_adsmp_add_styles' => 'checked',
            'msbd_adsmp_content_top_script' => '',
            'msbd_adsmp_content_bottom_script' => '',
        );
    ...
    public function set_to_defaults() {
        delete_option($this->adsm_options_name);
    ...
    public function update_options() {
        ...
        if (isset($_POST['action']) && $_POST['action'] === 'msbd-adsmp-update-options') {
                        
            if (!isset($_POST['msbd_adsmp_add_styles'])) { 
                $_POST['msbd_adsmp_add_styles'] = NULL; 
            }
            
            if (!isset($_POST['msbd_adsmp_content_top_script'])) { 
                $_POST['msbd_adsmp_content_top_script'] = NULL; 
            } else {
                $_POST['msbd_adsmp_content_top_script'] = $this->core->msbd_sanitization($_POST['msbd_adsmp_content_top_script'], "html_js");
            }
            
            if (!isset($_POST['msbd_adsmp_content_bottom_script'])) { 
                $_POST['msbd_adsmp_content_bottom_script'] = NULL; 
            } else {
                $_POST['msbd_adsmp_content_bottom_script'] = $this->core->msbd_sanitization($_POST['msbd_adsmp_content_bottom_script'], "html_js");
            }
            ...
            $_POST['action'] = NULL;
            $this->updated = 'msbd-adsmp-update-options';
    ...
    */
    public function get_option($opt_name = '') {
       ...
       $options = get_option($this->adsm_options_name);
    ...
    */
    public function update_option($opt_name, $opt_val = '') {
       ...
       if (is_array($opt_name) && $opt_val == '') {
           ...
           update_option($this->adsm_options_name, array_merge($current_options, $new_option));
       }
    }
    ...
    */
    ...
    public function update_messages() {
        if ($this->updated == 'msbd-adsmp-update-options') {
...
/* end of file msbd-adsm-options.php */
